...
class MarginTokens extends ThemeExtension<MarginTokens> {
  const MarginTokens({
  ...
  @override
  MarginTokens copyWith({double? level1, double? level2, double? level3, double? level4, double? level5}) {
    return MarginTokens(
  ...
  @override
  MarginTokens lerp(ThemeExtension<MarginTokens>? other, double t) {
    if (other is! MarginTokens) return this;
    return MarginTokens(
